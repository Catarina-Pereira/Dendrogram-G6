...
export function useTypingData() {
    ...
    useEffect(() => {
        ...
        const data: any = {}
        Promise.all([
            MockVisualizationService.getTypingDataSchema(projectId!, typingDataId!)
            ...
            MockVisualizationService.getTypingDataProfiles(projectId!, typingDataId!, MAX_INTEGER, 0)
