        ...
        handleNext: async () => {
            ...
            if (createDatasetStep === CreateDatasetStep.INFO) {
                ...
                if (typingDataFile) {
                    ...
                    await MockFileTransferService.uploadTypingData(project?.projectId!, typingDataFile, datasetType)
                ...
                if (isolateDataFile) {
                    ...
                    await MockFileTransferService.uploadIsolateData(project?.projectId!, isolateDataFile)
                        .then(res => isolateDataId = res.isolateDataId)
                        .catch(err => setError(err.message))
                }


                MockAdministrationService.createDataset(
                    project?.projectId!,
                    {
                        name,
                        description,
                    ...
                    .then((output) => {
                        ...
                        createWorkflow({
                            type: "index-typing-and-isoalte-data",
                            properties: {
                                datasetId: output.datasetId
                            }
                        })
